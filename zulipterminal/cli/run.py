...
def parse_args(argv: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--exit-confirmation",
        dest="exit_confirmation",
        default=None,
        action="store_const",
        const="enabled",
        help="enable confirmation before exiting",
    )
    parser.add_argument(
        ...
        action="store_const",
        const="disabled",
        help="disable confirmation before exiting",
    )
...
def main(options: Optional[List[str]] = None) -> None:
    ...
    try:
        ...
        if args.exit_confirmation:
            zterm["exit_confirmation"] = SettingData(
                args.exit_confirmation, ConfigSource.COMMANDLINE
            )
